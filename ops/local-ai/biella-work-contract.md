...
- The boundary is the approved Biella goal, vision, task, and authoritative source state. Do not perform unrelated work.
...
- Keep every configured Biella capability available. Demand-load external tools only when the task benefits from them.
