...
def task_context(repo: Path, task_id: str) -> str:
    ...
    return (
        ...
        "Source publication retries belong to the GitHub publication cursor and never trigger task replay. "
...
def _render_human_readable(data: dict[str, Any]) -> str:
    def bullets(value: Any) -> str:
        ...
        return str(value or "")
    lines = [
        "# MiniTZ — canonical task projection", "",
