...
readonly RUNTIME="${MINITZ_AI_RUNTIME_ENV:-/root/attached-storage/minitz-os-sandbox/state/credentials/runtime.env}"
...
updates_file="$(mktemp /tmp/minitz-provider-updates.XXXXXX)"
...
printf 'MiniTZ provider configuration. Enter keeps existing values.\n'
...
ask_secret MINITZ_GOOGLE_API_KEY 'General Google API key'
