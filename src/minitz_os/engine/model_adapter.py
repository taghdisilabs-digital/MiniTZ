...
_RESULT_MEDIA_TYPE = "application/vnd.minitz.model-result+json"
_RECEIPT_MEDIA_TYPE = "application/vnd.minitz.model-receipt+json"
...
class _BaseModelAdapter:
        ...
        for operation in deployment.operations:
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": f"schema://minitz/model-{operation.value}-request/1"},
                    output_contract={"result": f"schema://minitz/model-{operation.value}-result/1"},
                    side_effects=(),
                )
            )
    ...
    def _publish_result(
        ...
        if failure is None:
            ...
            output_artifact = self.artifacts.publish_from_run(
                ...
                metadata={
                    ...
                    "schema_ref": f"schema://minitz/model-{operation.value}-result/1",
        ...
        receipt_artifact = self.artifacts.publish_from_run(
            ...
            derivation_type=f"model.{operation.value}",
            metadata={"media_type": receipt_ref.media_type, "schema_ref": "schema://minitz/model-receipt/1", "schema_version": "1.0.0"},
        )
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            database_path,
            object_store,
            adapter_ref="adapter://minitz/model/reference-v1",
            reality="REFERENCE",
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            database_path,
            object_store,
            adapter_ref="adapter://minitz/model/hosted-http-v1",
            reality="REAL",
            tool_executor=tool_executor,
        )
