...
_RESULT_MEDIA = "application/vnd.minitz.browser-result+json"
_RECEIPT_MEDIA = "application/vnd.minitz.browser-receipt+json"
        ...
        for name in _CAPABILITY_NAMES:
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": f"schema://minitz/{name.replace('.', '-')}-request/1"},
                    output_contract={"result": f"schema://minitz/{name.replace('.', '-')}-result/1"},
    ...
    def _start_tool(
        ...
        try:
            return self.calls.start_tool_call(
                ...
                tool_id=f"tool://minitz/{capability_ref.capability_id.replace('.', '/')}",
        ...
        *,
        ...
        return self.artifacts.publish_from_run(
            ...
            metadata={
                ...
                "schema_ref": f"schema://minitz/{semantic_label}/1",
...
class ReferenceBrowserAdapter(_BaseBrowserAdapter):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            object_store,
            http_adapter,
            adapter_ref="adapter://minitz/browser/reference-v1",
            implementation_ref="runtime://minitz/browser/reference-v1",
            reality="REFERENCE",
        )
    ...
    def crash_session(self, identity: BrowserSessionIdentity) -> None:
        """Simulate provider loss without rewriting durable MiniTZ evidence."""
        with self._session_lock:
...
class WebDriverBrowserAdapter(_BaseBrowserAdapter):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            object_store,
            http_adapter,
            adapter_ref="adapter://minitz/browser/w3c-webdriver-v1",
            implementation_ref="runtime://minitz/browser/w3c-webdriver-v1",
            reality="REAL",
        )
                    ...
                    if condition.condition_type is BrowserWaitConditionType.SELECTOR:
                        ...
                        if not event_initialized:
                            self._wd(
                                ...
                                "/execute/sync",
                                {
                                    "script": "window.__minitzObservedEvents=window.__minitzObservedEvents||{}; const n=arguments[0]; if(!window.__minitzObservedEvents[n]){window.addEventListener(n,()=>{window.__minitzObservedEvents[n]=true;},{once:true});} return true;",
                        ...
                        found = self._wd(
                            ...
                            "/execute/sync",
                            {
                                "script": "return window.__minitzObservedEvents?.[arguments[0]]===true;",
                                "args": [condition.event_name],
                            },
                            max(0.1, deadline - time.monotonic()),
                        ) is True
