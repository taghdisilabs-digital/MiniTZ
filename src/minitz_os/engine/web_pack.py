"""Web application production-pack data for the universal MiniTZ substrate."""
...
def _capability(name: str) -> Capability:
    ...
    return Capability(
        ...
        input_contract={
            ...
            "repository": "minitz://contracts/repository-ref/v1",
            "task": "minitz://contracts/task-ref/v1",
        },
        output_contract={output_role: f"minitz://contracts/web-{output_role}/v1"},
