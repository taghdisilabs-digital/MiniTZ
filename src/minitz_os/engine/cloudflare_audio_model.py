...
class CloudflareAudioModel:
    ...
    def _audio_metadata(
        ...
        return {
            ...
            "schema_ref": "schema://minitz/audio-generated/v1",
    ...
    def _publish_success(
        ...
        try:
            validation_artifact = self.artifacts.publish_from_run(
                ...
                metadata={
                    "media_type": _VALIDATION_MEDIA_TYPE,
                    "schema_ref": "schema://minitz/audio-validation/full-decode/v1",
                    "schema_version": "1.0.0",
    ...
    def _record_failure(
        ...
        try:
            ...
            evidence_artifact = self.artifacts.publish_from_run(
                ...
                metadata={
                    "media_type": _VALIDATION_MEDIA_TYPE,
                    "schema_ref": "schema://minitz/audio-validation/failure/v1",
                    "schema_version": "1.0.0",
                    "semantic_label": "audio.validation-evidence",
                },
            )
