...
_REQUEST_MEDIA_TYPE = "application/vnd.minitz.process-request+json"
_RESULT_MEDIA_TYPE = "application/vnd.minitz.process-result+json"
_STDOUT_MEDIA_TYPE = "application/vnd.minitz.process-output"
_STDERR_MEDIA_TYPE = "application/vnd.minitz.process-output"
_READ_CHUNK = 64 * 1024
_CONTENT_DESCRIPTOR_PREFIX = "@minitz-content-fd:"
_DIRECTORY_DESCRIPTOR_PREFIX = "@minitz-directory-fd:"
_LAUNCH_GATE_SCRIPT = """
import os
import sys
...
class ManagedProcessAdapter:
        ...
        for shell in (False, True):
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": "schema://minitz/process-request/1"},
            ...
            try:
                ...
                implementation = self.implementations.register(
                    ...
                    CapabilityImplementation(
                        ...
                        "adapter://minitz/managed-process",
                        "runtime://python/posix-process",
                        tool_ref=f"tool://minitz/process/{operation}",
    ...
    def _publish_artifact(
        ...
        metadata = {
            ...
            "schema_ref": "schema://minitz/process-result/1",
