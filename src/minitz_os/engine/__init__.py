"""MiniTZ engine capability surface.

Migration-only interfaces are deliberately isolated in :mod:`minitz_os.engine.migration`.
"""
...
from .security_privacy import (
    ...
    IntegrityManifest,
    NetworkMode,
    NetworkPolicy as SecurityNetworkPolicy,
    NetworkPolicyError,
    PrivacyError,
    RecoveryError,
    RecoveryManager,
