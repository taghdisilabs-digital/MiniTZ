...
def _capability(name: str) -> Capability:
    ...
    return Capability(
        ...
        input_contract={
            "candidate": "minitz://contracts/workspace-snapshot-ref/v1",
            "game_project": "minitz://contracts/game-project-identity/v1",
            "project": "minitz://contracts/project-ref/v1",
            "task": "minitz://contracts/task-ref/v1",
        },
        output_contract={
            output_name: f"minitz://contracts/{output_contract}/v1",
        },
