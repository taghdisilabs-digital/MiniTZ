...
def _capability(name: str, description: str, output_name: str, output_contract: str) -> Capability:
    ...
    return Capability(
        ...
        input_contract={
            "project": "minitz://contracts/project-ref/v1",
            "task": "minitz://contracts/task-ref/v1",
            "run": "minitz://contracts/run-ref/v1",
            "graph": "minitz://contracts/graph-ref/v1",
        },
...
def _capabilities() -> tuple[Capability, ...]:
    definitions = [
        _capability(
            ...
            "requirements",
            "minitz://contracts/production-requirements/v1",
        )
    ]
    definitions.extend(
        _capability(
            ...
            "component",
            "minitz://contracts/production-component-artifact/v1",
        )
    ...
    definitions.extend(
        (
            _capability(
                ...
                "integration",
                "minitz://contracts/production-integration-output/v1",
            ),
            _capability(
                "build",
                "Build the exact integrated production candidate.",
                "build",
                "minitz://contracts/production-build-output/v1",
            ),
            _capability(
                "runtime-validation",
                "Validate observed runtime evidence for the exact build.",
                "validation",
                "minitz://contracts/production-validation-result/v1",
            ),
            _capability(
            ...
            _capability(
                ...
                "package",
                "minitz://contracts/production-package-output/v1",
            ),
        )
    )
...
def compile_large_scale_graph_nodes(
    *,
    ...
    requirements = Node(
        ...
        (),
        (),
        {"requirements": "minitz://contracts/production-requirements/v1"},
        None,
        "READ_ONLY",
    ...
    for branch in recipe.branches:
        ...
        branches.append(
            Node(
                ...
                (requirements_ref,),
                tuple(inputs),
                {"component": "minitz://contracts/production-component-artifact/v1"},
                None,
                "PROJECT_WRITE",
                {
    ...
    integration = Node(
        ...
        {"integration": "minitz://contracts/production-integration-output/v1"},
        None,
        "PROJECT_WRITE",
    ...
    build = Node(
        ...
        {"build": "minitz://contracts/production-build-output/v1"},
        None,
        "PROJECT_WRITE",
    ...
    runtime = Node(
        ...
        {"validation": "minitz://contracts/production-validation-result/v1"},
        None,
        "READ_ONLY",
    ...
    package = Node(
        ...
        {"package": "minitz://contracts/production-package-output/v1"},
        None,
        "PROJECT_WRITE",
        {
