...
class ProjectCellManifest:
    ...
    def __post_init__(self) -> None:
        ...
        if workspace_path == _ENGINE_SOURCE_ROOT or _ENGINE_SOURCE_ROOT in workspace_path.parents:
            raise ProjectCellContractError("workspace_root must not be the MiniTZ Engine source root")
        if artifacts == cache:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.project_cell_manifest/v1",
...
class TaskEnvelope:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.task_envelope/v1", "task_id": self.task_id,
...
class RemoteAssistanceRequest:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.remote_assistance_request/v1",
...
class RemoteAssistanceResponse:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.remote_assistance_response/v1",
...
class BlockerRecord:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.project_cell_blocker/v1",
...
class ProjectCellCheckpoint:
    ...
    def to_payload(self) -> dict[str, Any]:
        return {
            "schema": "minitz.project_cell_checkpoint/v1",
