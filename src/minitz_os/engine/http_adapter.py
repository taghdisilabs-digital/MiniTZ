...
_REQUEST_MEDIA_TYPE = "application/vnd.minitz.http-execution-request+json"
_RECEIPT_MEDIA_TYPE = "application/vnd.minitz.http-execution-receipt+json"
        ...
        for operation in _OPERATIONS:
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": "schema://minitz/http-execution-request/1"},
            ...
            try:
                ...
                implementation = self.implementations.register(
                    ...
                    CapabilityImplementation(
                        ...
                        tool_ref=f"tool://minitz/http/{operation}",
        ...
        *,
        ...
        if observation.response_ref is not None:
            response_artifact = self.artifacts.publish_from_run(
                ...
                metadata={
                    ...
                    "schema_ref": "schema://minitz/http-response/1",
        ...
        receipt_artifact = self.artifacts.publish_from_run(
            ...
            metadata={
                ...
                "schema_ref": "schema://minitz/http-execution-result/1",
                "schema_version": "1.0.0",
            },
        )
        call_key = _digest({"attempt": attempt.record_sha256, "idempotency_key": idempotency_key})
