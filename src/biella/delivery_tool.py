...
class HmacSha256SigningSpec:
    ...
    key_ref: str
    signer_ref: str = "signer://biella/test-hmac-sha256/v1"
    metadata_ref: str = "signature-config://biella/test-hmac-sha256/v1"
...
class DeterministicLocalDeliveryTool:
    ...
    def __init__(
        ...
        *,
        ...
        tool_ref: str = "tool://biella/local-delivery/1.0.0",
        runtime_ref: str = "runtime://biella/local-delivery/python-stdlib/1",
    ) -> None:
    ...
    def _publish(
        ...
        *,
        ...
        artifact = self.artifacts.publish_from_run(
            ...
            metadata={
                "media_type": media_type,
                "schema_ref": "schema://biella/delivery-local-artifact/1",
    ...
    def _manifest_payload(
        ...
        payload = {
            ...
            "schema_ref": "schema://biella/delivery-local-package-manifest/1",
            "schema_version": "1.0.0",
    ...
    def _local_package(
        ...
        if record.manifest_artifact_ref is None:
            manifest_ref = self._publish(
                ...
                media_type="application/vnd.biella.delivery-manifest+json",
                sources=resolved,
        ...
        return _json_bytes(
            {
                ...
                "schema_ref": "schema://biella/delivery-local-verification/1",
                "schema_version": "1.0.0",
        ...
        try:
            ...
            if signing is None:
                ...
                if record.signature_artifact_ref is None:
                    signature_ref = self._publish(
                        ...
                        media_type="application/vnd.biella.delivery-signature+json",
            ...
            if record.evidence_artifact_ref is None:
                evidence_ref = self._publish(
                    ...
                    media_type="application/vnd.biella.delivery-verification+json",
