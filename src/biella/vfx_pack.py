...
def vfx_production_pack() -> ProductionPack:
    capabilities = tuple(Capability(CapabilityRef(f"vfx.{name}", "1.0.0"), f"Bounded vfx {name}", {}, {"result": f"biella://contracts/vfx-{name}/v1"}, (), "2026-08-31T00:00:00+00:00") for name in _NAMES)
