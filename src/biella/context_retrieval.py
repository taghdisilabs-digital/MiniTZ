    ...
    def search(
        ...
        *,
        ...
        receipt_content_ref = self.object_store.put(
            ...
            media_type="application/vnd.biella.retrieval-receipt+json",
        )
    ...
    def compileContext(
        ...
        if not context_limit:
            for material, payload in selected:
                ...
                framed.extend(b"[BIELLA_CONTEXT_BEGIN]")
        ...
        context_ref = (
            ...
            if context_limit
                ...
                bytes(framed),
                media_type="application/vnd.biella.compiled-context",
            )
        )
        ...
        receipt_content_ref = self.object_store.put(
            _json(receipt_basis).encode(),
            media_type="application/vnd.biella.context-receipt+json",
        )
