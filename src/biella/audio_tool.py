"""REAL deterministic audio processing on existing Biella authorities."""
...
class DeterministicAudioTool(AudioToolAdapter):
    ...
    def inspect(
        ...
        analysis = self._publish(
            ...
            metadata={
                "schema_ref": "schema://biella/audio-analysis/1",
    ...
    def _execute_authorized(
        ...
        output = self._publish(
            ...
            metadata={
                "schema_ref": "schema://biella/audio-output/1",
                "schema_version": "1.0.0",
            },
        )
    ...
    def execute_stems(
        ...
        with ThreadPoolExecutor(
            max_workers=len(specification_map), thread_name_prefix="biella-audio"
        ) as executor:
            futures = {
                key: executor.submit(
    ...
    def _mix_once(
        ...
        *,
        ...
        for index, (source, source_metadata, level) in enumerate(
            ...
            stage_name = f".biella-audio-{token}-stem-{index}{suffix}"
    ...
    def mix(
        ...
        output_ref = self._publish(
            ...
            metadata={
                "schema_ref": "schema://biella/audio-mix/1",
                "schema_version": "1.0.0",
            },
        )
        ...
        session_ref = self._publish(
            ...
            metadata={
                "schema_ref": "schema://biella/audio-session/1",
                "schema_version": "1.0.0",
            },
        )
        session = EditableAudioSessionBinding(
