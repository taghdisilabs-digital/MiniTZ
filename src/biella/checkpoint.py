...
_SCHEMA_VERSION = "biella.run-checkpoint/v1"
_MEDIA_TYPE = "application/vnd.biella.run-checkpoint+json"
    ...
    def resume_run(
        ...
        *,
        ...
        evidence_ref = self.object_storage.put(
            evidence_bytes,
            media_type="application/vnd.biella.checkpoint-reconciliation+json",
