...
def _cap(n:str)->Capability:
    return Capability(CapabilityRef(f"environment.{n}","1.0.0"),f"Perform bounded environment {n.replace('_',' ')} work.",{"project":"biella://contracts/project-ref/v1"},{"result":f"biella://contracts/environment-{n.replace('_','-')}/v1"},("workspace.process.execute","workspace.filesystem.write","workspace.artifact.create"),"2026-08-31T00:00:00+00:00")
