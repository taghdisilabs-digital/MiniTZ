...
_REQUEST_MEDIA_TYPE = "application/vnd.biella.git-request+json"
_RECEIPT_MEDIA_TYPE = "application/vnd.biella.git-receipt+json"
_UNTRACKED_MEDIA_TYPE = "application/vnd.biella.git-untracked-manifest+json"
        ...
        for operation in _OPERATIONS:
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": "schema://biella/git-request/1"},
                    output_contract={"receipt": "schema://biella/git-receipt/1"},
            ...
            try:
                ...
                implementation = self.implementations.register(
                    ...
                    CapabilityImplementation(
                        ...
                        "adapter://biella/git",
                        "runtime://git/cli",
                        tool_ref=f"tool://biella/git/{operation}",
        ...
        *,
        ...
        artifact = self.artifacts.publish_from_run(
            ...
            metadata={
                ...
                "schema_ref": "schema://biella/git-receipt/1",
    ...
    def create_workspace(
        ...
        *,
        ...
        try:
            ...
            template_path = f".biella-template-{workspace_id}"
