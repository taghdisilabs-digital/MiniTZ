...
def image_production_pack() -> ProductionPack:
    capabilities = tuple(Capability(CapabilityRef(f"image.{name}", "1.0.0"), f"Bounded image {name}", {}, {"result": f"biella://contracts/image-{name}/v1"}, (), "2026-09-01T00:00:00+00:00") for name in IMAGE_CAPABILITIES)
