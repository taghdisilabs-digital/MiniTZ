...
serialized into Biella's durable state or object storage.
"""
...
_REQUEST_MEDIA_TYPE = "application/vnd.biella.postgresql-request+json"
_RECEIPT_MEDIA_TYPE = "application/vnd.biella.postgresql-receipt+json"
_RESULT_MEDIA_TYPE = "application/vnd.biella.postgresql-rows+jsonl"
    ...
    def create_project(
        ...
        *,
        ...
        return cls(
            ...
            "adapter://biella/database/postgresql/libpq",
            endpoint_identity,
            database_identity,
            auth_profile_ref,
            tls,
...
class LibpqPostgreSQLAdapter:
        ...
        for operation in _OPERATIONS:
            ...
            capability = self.capabilities.register(
                Capability(
                    ...
                    input_contract={"request": f"schema://biella/postgresql-{operation}-request/1"},
                    output_contract={"result": f"schema://biella/postgresql-{operation}-result/1"},
            ...
            try:
                ...
                implementation = self.implementations.register(
                    ...
                    CapabilityImplementation(
                        ...
                        tool_ref=f"tool://biella/database/postgresql/{operation}",
    ...
    def register_connection(
        ...
        *,
        ...
        if connection_record.database_identity in self.internal_database_identities:
            raise DatabaseAuthorityError("Biella internal database identity is not Project database authority")
    ...
    def _new_backend_connection(
        ...
        keyword_values = (
            ...
            ("application_name", "biella-project-adapter"),
        )
                ...
                if request.persist_result:
                    ...
                    artifact = self.artifacts.publish_from_run(
                        ...
                        metadata={
                            ...
                            "schema_ref": "schema://biella/postgresql-rows/1",
