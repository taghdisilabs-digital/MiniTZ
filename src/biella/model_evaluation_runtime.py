...
class ModelEvaluationMatrixRuntime:
    ...
    def publish_manifest(
        ...
        *,
        ...
        content = self.object_storage.put(
            data,
            media_type="application/vnd.biella.model-evaluation-matrix+json",
    ...
    def _publish_cell_result(
        ...
        content = self.object_storage.put(
            data,
            media_type="application/vnd.biella.model-evaluation-cell+json",
            expected_digest=hashlib.sha256(data).hexdigest(),
            expected_size=len(data),
        )
        sources = tuple(
    ...
    def publish_result(
        ...
        *,
        ...
        content = self.object_storage.put(
            data,
            media_type="application/vnd.biella.model-evaluation-result+json",
            expected_digest=hashlib.sha256(data).hexdigest(),
            expected_size=len(data),
        )
        return self.artifacts.publish_from_run(
