...
def video_production_pack() -> ProductionPack:
    capabilities = tuple(Capability(CapabilityRef(f"video.{name}", "1.0.0"), f"Bounded video {name}", {}, {"result": f"biella://contracts/video-{name}/v1"}, (), "2026-09-01T00:00:00+00:00") for name in VIDEO_CAPABILITIES)
