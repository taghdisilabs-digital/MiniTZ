...
def test_real_locality_evidence_import_contract() -> None:
    from biella.placement_learning_evidence import ExternalLocalityArtifacts, LocalityEvidenceBinding, import_p4_04_l40s_evidence
...
def test_locality_evidence_forgery_rejects() -> None:
    from biella.placement_learning_evidence import EvidenceImportError, import_p4_04_l40s_evidence
