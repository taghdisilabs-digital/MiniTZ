...
for e,a in zip(expected,actual):
    ...
    assert not anim.get_editor_property('enable_root_motion')
    records.append(dict(animation=anim.get_path_name(),direction=pos.x,speed=pos.y,rate=a.get_editor_property('rate_scale')))
