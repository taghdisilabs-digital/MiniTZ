...
result = {}
for name in ('/Engine/BasicShapes/Cube', '/Game/Environment/ServiceHall/SM_ServiceHallCladding', '/Game/Environment/ServiceHall/SM_HallInterior', '/Game/Environment/TerraceRoute/SM_TerraceRoute'):
