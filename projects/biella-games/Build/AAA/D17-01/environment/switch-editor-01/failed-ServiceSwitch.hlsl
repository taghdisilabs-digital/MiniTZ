...
float triangle=S.Mask(max(abs(t.x)*.866+t.y*.5-.46,-t.y-.52)*3.2,aa);
float boltMark=S.Mask(S.Box(p-float2(-9,14),float2(.22,1.2),.05),aa)*triangle;
color=lerp(color,float3(.44,.29,.065),triangle*(.62+.2*coarse));
