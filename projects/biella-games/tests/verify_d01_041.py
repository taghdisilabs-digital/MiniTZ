...
def verify() -> dict[str, object]:
    ...
    if metadata.get("visual_index") != "projects/biella-games/Build/Demo01/D01-041-visual-index.json":
    ...
    return {
        ...
        "index": {
            "path": "projects/biella-games/Build/Demo01/D01-041-visual-index.json",
