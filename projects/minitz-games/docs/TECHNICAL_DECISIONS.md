...
- project-specific game source lives under `projects/minitz-games/` inside canonical `patrickminitz-web/biella-engine`; repository unification does not make that source reusable Engine scope;
