# AAA-SF-027 — Run the post-repair external replay

Status: `FUTURE_BLOCKED`
Phase: `P3` — Independent player proof
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-026` durably closed
Next task: `AAA-SF-028`
...
Give the repaired package to an external player and repeat the affected scenario without founder steering.
...
Post-repair session evidence.

## Validation contract

Previously targeted blockers are no longer acceptance-blocking; new failures are recorded without expanding the task into unrelated redesign.

## Required evidence

Session logs/captures, package digest, comparison to prior findings.
