...
Assemble current build, performance, stability, persistence, diagnostics, update, and clean-machine results into one release-operations evidence set.
...
Release-operations qualification bundle.

## Validation contract

Every accepted release claim points to fresh exact-build evidence; stale predecessor logs are references only.

## Required evidence

Bundle index/digest, Git source identity, Drive readback.
