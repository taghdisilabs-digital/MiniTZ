# AAA-SF-018 — Qualify audio, VFX, HUD, and gameplay readability

Status: `FUTURE_BLOCKED`
Phase: `P2` — AAA vertical-slice proof
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-017` durably closed
Next task: `AAA-SF-019`
...
Verify event-driven audio/VFX/UI communicate real gameplay state without obscuring targets, routes, hazards, or decisions.
...
Readability evidence and task-scoped fixes to existing implemented feedback.

## Validation contract

Critical events are perceptible and attributable; UI/VFX/audio do not claim mechanics absent from runtime state and do not block gameplay readability.

## Required evidence

Raw capture with audio, HUD/state event trace, exact source/asset identities.
