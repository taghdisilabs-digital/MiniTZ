...
Produce and validate the accepted Win64 Shipping configuration after performance/stability repairs.
...
Shipping package with exact source/build identity and clean-machine play evidence.

## Validation contract

Package launches outside editor, completes the canonical slice, persists required state, and exits/relaunches cleanly on the qualified environment.

## Required evidence

Shipping package digest, runtime logs, raw play capture.
