# AAA-SF-003 — Create the post-program evidence namespace

Status: `FUTURE_BLOCKED`
Phase: `P0` — Activation and truth lock
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-002` durably closed
Next task: `AAA-SF-004`
...
Create one bounded evidence namespace for AAA-SF outputs without modifying prior production evidence or creating a second game authority root.
...
Repository evidence index plus matching Drive folder/path for AAA-SF evidence, with naming and identity rules for builds, playtests, metrics, and proof artifacts.

## Validation contract

A fresh artifact can be written, identified, read back, and linked from the index without touching predecessor evidence.

## Required evidence

Repository commit/tree, Drive folder/file IDs, and test artifact readback.
