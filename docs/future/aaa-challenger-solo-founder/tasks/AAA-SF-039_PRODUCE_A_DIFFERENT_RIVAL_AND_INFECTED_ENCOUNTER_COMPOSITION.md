# AAA-SF-039 — Produce a different rival and infected encounter composition

Status: `FUTURE_BLOCKED`
Phase: `P5` — Repeatable content production
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-038` durably closed
Next task: `AAA-SF-040`
...
Use existing actor/system definitions to create a meaningfully different interaction pattern without forking core AI behavior per encounter.
...
Second encounter composition and runtime evidence.

## Validation contract

Rival/infected behavior remains driven by shared systems and current approved tuning/content data, with real state interaction.

## Required evidence

Encounter data/source identity, raw gameplay/event trace.
