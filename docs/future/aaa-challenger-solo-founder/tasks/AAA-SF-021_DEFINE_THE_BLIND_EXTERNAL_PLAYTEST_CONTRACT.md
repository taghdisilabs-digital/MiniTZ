# AAA-SF-021 — Define the blind external playtest contract

Status: `FUTURE_BLOCKED`
Phase: `P3` — Independent player proof
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-020` durably closed
Next task: `AAA-SF-022`
...
Define what an external player receives, what founder help is prohibited during the session, what evidence is collected, and what counts as completion/failure.
...
Consent-aware playtest protocol and telemetry/question set limited to product evaluation.

## Validation contract

Protocol can be run without exposing internal secrets or requiring founder coaching; success criteria derive from the playable product rather than investor narrative.

## Required evidence

Protocol file and test package identity.
