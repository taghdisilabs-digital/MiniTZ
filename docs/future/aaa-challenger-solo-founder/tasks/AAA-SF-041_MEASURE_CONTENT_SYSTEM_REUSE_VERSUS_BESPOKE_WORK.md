# AAA-SF-041 — Measure content-system reuse versus bespoke work

Status: `FUTURE_BLOCKED`
Phase: `P5` — Repeatable content production
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-040` durably closed
Next task: `AAA-SF-042`
...
Quantify which second-scenario outputs were achieved through reusable data/assets/systems and which required new implementation.
...
Reuse report tied to source diffs and production task evidence.

## Validation contract

Counts/times come from real changed files/tasks/traces; no claim of reuse is based only on architecture intent.

## Required evidence

Git diff stats, task/run identities, categorized reuse record.
