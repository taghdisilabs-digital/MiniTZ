# AAA-SF-058 — Recover the pilot after a bounded infrastructure interruption

Status: `FUTURE_BLOCKED`
Phase: `P7` — Biella Engine external replication
Project: Biella Engine
Repository: `patrickminitz-web/biella-engine`
Predecessor: `AAA-SF-057` durably closed
Next task: `AAA-SF-059`
...
Introduce or use a real bounded interruption and verify smallest-boundary recovery.
...
External recovery benchmark.

## Validation contract

Only invalidated work is retried; verified unaffected artifacts/state are preserved; continuation reaches the same project truth.

## Required evidence

Failure evidence, recovery actions, resulting task/run/artifact identities.

## New source/reuse constraint

Use a bounded interruption that cannot destroy unique state. Recovery must demonstrate smallest-boundary reconstruction and continuation, with pre/post source/artifact identities and no reset of verified pilot progress.
