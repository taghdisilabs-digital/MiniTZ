# AAA-SF-004 — Bind the production-ready predecessor build

Status: `FUTURE_BLOCKED`
Phase: `P0` — Activation and truth lock
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-003` durably closed
Next task: `AAA-SF-005`
...
Bind the exact build/package produced by the predecessor release program as the starting artifact for AAA-SF proof. Do not rebuild merely because this program started.
...
Artifact bytes/digest and source identity match predecessor closure; if missing/corrupt, record predecessor invalidation and stop instead of silently substituting a new build.
