# AAA-SF-026 — Repair the highest-impact reproducible external blockers

Status: `FUTURE_BLOCKED`
Phase: `P3` — Independent player proof
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-025` durably closed
Next task: `AAA-SF-027`
...
Fix only product defects clearly evidenced by external sessions and revalidate their affected boundaries.
...
Task-scoped source/content changes plus focused regression evidence.

## Validation contract

Each fixed blocker is reproduced before repair where possible, no longer reproduces after repair, and unaffected verified behavior is preserved.

## Required evidence

Before/after evidence, commit/tree, new package identity.
