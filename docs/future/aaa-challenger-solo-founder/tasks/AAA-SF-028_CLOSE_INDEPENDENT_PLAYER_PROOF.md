...
Assemble external-play evidence sufficient to demonstrate the game can be installed, understood, and played beyond the founder environment.
...
Independent-player proof bundle with exact session/build identities and bounded qualitative/quantitative findings.

## Validation contract

Bundle distinguishes observed facts, participant statements, and interpretation; no claim of broad market validation is made from a small cohort.

## Required evidence

Bundle index/digest, session references, Drive readback.
