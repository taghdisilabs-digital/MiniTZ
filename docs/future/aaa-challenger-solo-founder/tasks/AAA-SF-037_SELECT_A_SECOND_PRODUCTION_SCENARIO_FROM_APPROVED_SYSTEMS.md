# AAA-SF-037 — Select a second production scenario from approved systems

Status: `FUTURE_BLOCKED`
Phase: `P5` — Repeatable content production
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-036` durably closed
Next task: `AAA-SF-038`
...
Choose a materially different scenario that reuses existing systems and approved content vocabulary rather than introducing a new project identity.
...
Second-scenario production brief with reuse targets, required variation, and acceptance scenario.

## Validation contract

Scenario is distinct enough to test repeatability but remains within accepted mechanics, art direction, and current project scope.

## Required evidence

Brief, source/asset references, acceptance route.
