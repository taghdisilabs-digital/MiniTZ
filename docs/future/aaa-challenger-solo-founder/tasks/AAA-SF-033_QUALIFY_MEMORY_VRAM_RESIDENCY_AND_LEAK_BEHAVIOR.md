...
Measure resource residency through traversal, combat, restart, and repeated scenario execution.
...
Resource qualification record and leak/residency fixes where evidenced.

## Validation contract

RAM/VRAM/resource use is bounded for accepted scenarios and does not grow materially from lifecycle defects across repeated runs.

## Required evidence

Resource traces, lifecycle logs, build/source identity.
