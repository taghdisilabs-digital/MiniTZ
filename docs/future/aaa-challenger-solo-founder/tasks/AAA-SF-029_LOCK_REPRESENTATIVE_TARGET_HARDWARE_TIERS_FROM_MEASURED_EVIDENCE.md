# AAA-SF-029 — Lock representative target hardware tiers from measured evidence

Status: `FUTURE_BLOCKED`
Phase: `P4` — Performance, stability, and release operations
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-028` durably closed
Next task: `AAA-SF-030`
...
Each accepted value has measured evidence and owner/delegated authority; no GPU/RAM/VRAM target is inferred from installed hardware alone.

## Required evidence

Decision diff, telemetry source IDs, commit/tree.
