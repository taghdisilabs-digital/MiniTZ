# AAA-SF-022 — Prepare the founder-independent playtest handoff

Status: `FUTURE_BLOCKED`
Phase: `P3` — Independent player proof
Project: Biella Games
Repository: `patrickminitz-web/biella-games`
Predecessor: `AAA-SF-021` durably closed
Next task: `AAA-SF-023`
...
Create the smallest package, instructions, and issue-report path needed for an outside player to install, launch, play, and report results.
...
External playtest handoff bundle.

## Validation contract

A person not using the development workspace can follow the instructions without hidden commands or direct founder intervention.

## Required evidence

Bundle digest, clean-machine dry run, instructions readback.
