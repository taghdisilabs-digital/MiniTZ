...
Run representative simultaneous player/rival/infected combat at the population level supported by current content and measure degradation.
...
Combat stress profile and bounded optimization changes if required.

## Validation contract

Simulation correctness and gameplay readability remain intact at the accepted scenario load; counts are evidence-driven rather than ambition-driven.

## Required evidence

Actor/event counts, CPU/GPU/frame telemetry, runtime logs.
